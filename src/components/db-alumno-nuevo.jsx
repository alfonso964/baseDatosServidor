import { nuevoAlumnoDB } from "@/lib/action";

function AlumnoNuevoDB() {
    return (
        <form className='my-10 grid grid-cols-[150px_auto] gap-4'>
            ...
            <div className='col-span-2 grid gap-2'>
                <button formAction={nuevoAlumnoDB} className='bg-green-600 text-white px-4 py-2 rounded-xl'>
                    Guardar alumno
                </button>
